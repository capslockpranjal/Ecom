...
import { getSellerOrders, isLoggedIn, OrderSummary } from "@/lib/api";
...
export default function SellerOrdersPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-slate-600">Manage fulfillment for your store.</p>
          ...
          {orders.map((order) => (
            ...
            >
              <div className="flex items-center justify-between gap-4">
                <div>
                  <p className="font-semibold">Seller order #{order.id.slice(0, 8)}</p>
